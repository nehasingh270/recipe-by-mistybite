...
const Navbar = () => {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://static.vecteezy.com/system/resources/thumbnails/007/404/936/small/cute-chef-cooking-restaurant-logo-cartoon-character-art-illustration-vector.jpg" className="h-8" alt="Recipe" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Mistybite</span>
    </a>
